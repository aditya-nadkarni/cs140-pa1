 ...
 * Only Process 0 conducts a result compiarsion. If failed, return a message string 
 * If successful, return NULL
 */
char *
pi_test (char *testmsg, long long int number_of_tosses, double threshold)
{
  double startwtime = 0,
    endwtime = 0;
  double error,
...
pi_test1 ()
{
  return pi_test ("Test 1", 1000000, 0.01);
}

char *
pi_test2 ()
{
  return pi_test ("Test 2", 100000000, 0.001);
}

char *
pi_test3 ()
{
  return pi_test ("Test 3", 1000000000, 0.0001);
}
